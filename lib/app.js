...
class Messenger extends EventEmitter {
  ...
  constructor (token = null, options = {}) {
    ...
    _verify.set(this, verify)
  }

  verifyWebhook (verifyToken, req, res) {
    return _verify.get(this.webhook)(verifyToken, req, res)
  }

  verifySignature (appSecret, req, res, buf) {
    return _verify.get(this.signature)(appSecret, req, res, buf)
  }
